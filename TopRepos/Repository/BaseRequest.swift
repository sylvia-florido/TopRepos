...
class BaseRequest: NSObject {
    ...
    // MARK: - Base Requests
    func taskForGETMethod<T: Decodable>(_ method: String, parameters: [String:AnyObject]?, responseType: T.Type, completionHandlerForGET: @escaping (_ response: T?, _ error: NSError?) -> Void) {
        
        guard let url = urlFromParameters(parameters, pathExtension: method) else {
            return
        }
